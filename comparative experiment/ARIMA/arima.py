...
parser.add_argument('--model', type=str, default='ARIMA', metavar='N', help='model')
#
...
#==============================================================================
model = ARIMA(Ytrain, order=(args.p,args.d,args.q))
#==============================================================================
# Training
#==============================================================================
model = model.fit()
...
# Prediction
#==============================================================================
Ypred = model.predict(start=t-args.dy,end=t-1,dynamic=False,typ='levels')[1:]
#==============================================================================
# result
#==============================================================================
